...
# To make line numbers be identical with the book, this statement is written here. Don't move it to the header.rostest.rosrun('pimouse_ros','travis_test_buzzer',BuzzerTest)
